...
const ConfirmEmail = async (email, username, OTP) => {
  ...
  const mailOptions = {
    from: `Fullstacklab ${process.env.SMTP_AUTH_USER}`,
    to: email,
    subject: 'Confirm your account',
    html: `<div style="font-family: Helvetica,Arial,sans-serif;min-width:1000px;overflow:auto;line-height:2">
    <div style="margin:50px auto;width:70%;padding:20px 0">
      <div style="border-bottom:1px solid #eee">
        <a href="" style="font-size:1.4em;color: #00466a;text-decoration:none;font-weight:600">Fullstacklab</a>
      </div>
      ...
      <p style="font-size:0.9em;">Regards,<br />Fullstacklab</p>
...
const ResetPassword = async (email, username, token) => {
  ...
  const mailOptions = {
    ...
    <div style="margin:50px auto;width:70%;padding:20px 0">
      ...
      <p style="font-size:1.1em">Hi ${username},</p>
      <p>Thank you for being a valuable member of Fullstacklab. Use the following Link to reset your password. link is valid for 5 minutes</p>
...
const UpdateEmail = async (email, OTP) => {
  ...
  const mailOptions = {
    ...
    <div style="margin:50px auto;width:70%;padding:20px 0">
      ...
      <p>Thank you for being a valuable member of Fullstacklab. Use the following OTP to update your email. OTP is valid for 5 minutes</p>
      <h2 style="background: #00466a;margin: 0 auto;width: max-content;padding: 0 10px;color: #fff;border-radius: 4px;">${OTP}</h2>
      <p style="font-size:0.9em;">Regards,<br />Fullstacklab</p>
      <hr style="border:none;border-top:1px solid #eee" />
      <div style="float:right;padding:8px 0;color:#aaa;font-size:0.8em;line-height:1;font-weight:300">
